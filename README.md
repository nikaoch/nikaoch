...
![Readme Card](https://readmestats-inky.vercel.app/api/pin/?username=nikaoch&repo=eplayy&theme=dark)
...
Criada usando React.app, com Typescript como linguagem, Redux para gerenciamento de estado, React-Router-dom para rotas de navegação, Styled-components para estilização de forma mais organizada e de fácil entendimento, ESlint, Prettier e Editorconfig para formatação de código.
